...
class SmartMirrorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("IOT and AI project Smart Mirror")
        ...
        self.calendar_frame = self.create_label_frame("Calendar", 20)
...
class SmartMirrorApp:
    ...
    def setup_radio_player(self):
        pygame.mixer.init()
        self.radio_stream_url = 'https://pub0302.101.ru:8443/stream/pro/aac/64/103'  
    ...
    def listen_for_radio_command(self):
        # Implement voice recognition for radio control
        pass

    # Add methods for voice control integration here
