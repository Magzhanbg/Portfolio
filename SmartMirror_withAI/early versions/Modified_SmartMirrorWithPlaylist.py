...
class MusicPlayer:
    ...
    def play_music(self, music_file='west_coast.mp3'):  # Default music file
...
if __name__ == "__main__":
    ...
    root.
        ...
        self.play_button = Button(self, text='Play', command=self.music_player.select_song)
        self.play_button.pack()

        self.pause_button = Button(self, text='Pause', command=self.music_player.pause_music)
        self.pause_button.pack()

        self.resume_button = Button(self, text='Resume', command=self.music_player.resume_music)
        self.resume_button.pack()

        self.stop_button = Button(self, text='Stop', command=self.music_player.stop_music)
